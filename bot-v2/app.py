...
ALICE_WELCOME_MESSAGE = (
    ...
    "Puoi controllare personalmente il nostro conto reale su MetaTrader 5 con un accesso "
    "Investor in sola lettura, che permette di vedere conto, operazioni e storico senza "
    "poter aprire, modificare o chiudere operazioni. Chiedimi «accesso Investor» e ti aiuterò qui.\n\n"
