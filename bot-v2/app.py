...
ALICE_WELCOME_MESSAGE = (
    ...
    "Puoi controllare personalmente il nostro conto reale su MetaTrader 5 utilizzando "
    "un accesso Investor in sola lettura:\n\n"
    f"📊 Piattaforma: {MT5_INVESTOR_PLATFORM}\n"
    f"🏦 Broker: {MT5_INVESTOR_BROKER}\n"
    f"🌐 Server: {MT5_INVESTOR_SERVER}\n"
    f"👤 Login: {MT5_INVESTOR_LOGIN}\n"
    f"🔑 Password Investor: {MT5_INVESTOR_PASSWORD}\n\n"
    "Con queste credenziali puoi solamente vedere il conto, le operazioni e lo storico: "
    "non puoi aprire, modificare o chiudere operazioni.\n\n"
